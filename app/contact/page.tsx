...
export const metadata: Metadata = {
  ...
  description:
    "Έλα από το γυμναστήριο ή επικοινώνησε μαζί μας για οποιαδήποτε απορία, ή ιδέα έχεις. Παρέχουμε online coaching. Επικοινωνήστε με το Atlas Chania σήμερα στα Χανιά, Ελλάδα.",
  keywords:
          ...
          <div className="flex gap-12 sm:gap-20 md:gap-4 md:flex-row flex-col lg:gap-16 pt-20 md:pt-36 lg:px-14 overflow-x-hidden">
            <div className="w-full md:w-[50%] lg:w-[40%]">
              ...
              <p className="text-lg text-gray-600">
                ...
                απορία ή ιδέα έχεις ή αν θέλεις online coaching και θα μιλήσουμε
                αμέσως!
              </p>
