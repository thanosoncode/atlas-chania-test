...
export const metadata: Metadata = {
  ...
  description:
    "Μην το σκεφτεσαι! Έλα από το γυμναστήριο ή επικοινώνησε μαζί μας για οποιαδήποτε απορία, ιδέα ή αίτημα έχεις. Παρέχουμε online coaching. Επικοινωνήστε μαζί μας σήμερα στα Χανιά, Ελλάδα.",
  keywords:
