...
export const metadata: Metadata = {
  title: "Weightlifting",
  description:
    "Ανακαλύψτε τη Δύναμη της Ολυμπιακής Άρσης Βαρών στο Atlas Chania! Οι έμπειροι προπονητές μας θα σας καθοδηγήσουν σε σωστές τεχνικές και προγράμματα προπόνησης. Γίνετε μέλος της ομάδας μας για να ανυψώσετε, να ενισχύσετε και να κατακτήσετε τους φιτνες στόχους σας μέσα από την τέχνη της Ολυμπιακής άρσης βαρών.",
  keywords:
